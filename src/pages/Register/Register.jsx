            ...
            <div className="card-body">
              ...
              <div className="flex flex-col lg:flex-row gap-5">
                <div className="form-control lg:w-1/2">
                  ...
                  />
                  {errors.email && <span className="text-red-500 text-base">Enter Your Full Name</span>}
                </div>
                <div className="form-control lg:w-1/2">
                  <label className="label">
                    <span className="label-text">
                ...
                <div className="form-control lg:w-1/2">
                  ...
                  {errors.password && errors.password.type === "pattern" && (
                    <span className="text-red-500 text-base">
                      Password must be at least 8 characters long. Password must contain at least one capital
              ...
              <div className="flex flex-col lg:flex-row gap-5">
                <div className="form-control w-full mx-auto lg:w-1/2">
                  ...
                  />
                  {errors.number && (
                    <span className="text-red-500 text-base">Please Provide A valid 11 digit Number!</span>
                  )}
                </div>

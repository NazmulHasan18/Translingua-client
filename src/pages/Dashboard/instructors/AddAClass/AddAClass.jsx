...
const AddAClass = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(`${baseUrl}/add_class?email=${user?.email}`, classs, {
            ...
            <div className="card-body">
              ...
              <div className="flex flex-col lg:flex-row gap-5">
                <div className="form-control lg:w-1/2">
                  ...
                  />
                  {errors.class_name && <span className="text-red-500 text-base">Enter Your Class Name</span>}
                </div>
                <div className="form-control lg:w-1/2">
                  <label className="label">
                    <span className="label-text">
              ...
              <div className="flex flex-col lg:flex-row gap-5">
                ...
                <div className="form-control w-full lg:w-1/2">
                  ...
                  />
                  {errors.duration && (
                    <span className="text-red-500 text-base">Please Provide Your Class Duration</span>
                  )}
                </div>
              </div>
              <div className="form-control w-full">
                ...
                />
                {errors.image && (
                  <span className="text-red-500 text-base">Please Provide Your Class Image URL!</span>
                )}
              </div>

...
import { baseUrl, fetchInstructorById } from "../../API/api";
...
const Instructor = () => {
  ...
  useEffect(() => {
    ...
    axios(`${baseUrl}/instructors/${instructor?.email}/classes`, {
  ...
  return (
    <div>
      <div className="bg-orange-300">
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-between flex-col px-32 lg:flex-row items-center pb-10 mb-28 gap-10 container mx-auto">

   ...
   return (
      <div className="container mx-auto" data-aos="fade-up">
         ...
         <div className="flex gap-6 flex-col lg:flex-row-reverse bg-slate-200 mx-5 lg:mx-auto">
            ...
            <div>
               <div
                  className="flex justify-center gap-6 items-center p-5 m-5 rounded-[50px] bg-sky-200"
                  data-aos="fade-right"
               ...
               <div
                  className="flex justify-center gap-6 items-center p-5 m-5 rounded-[50px] bg-red-200"
                  data-aos="fade-left"
                  data-aos-duration="2000"
               >
                  <div>
               ...
               <div
                  className="flex justify-center gap-6 items-center p-5 rounded-[50px] m-5 bg-yellow-200"
                  data-aos="fade-right"
                  data-aos-duration="2000"
               >
